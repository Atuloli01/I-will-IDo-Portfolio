...
function showPopup() {
  ...
  popupImage.style.animation = "none"; // Reset animation
  setTimeout(() => {
    popupImage.style.animation = "fadeOut 3s forwards"; // Fade out after 3 seconds
  }, 0);
}

function hidePopup() {
  const popupImage = document.querySelector(".popup-image");
  popupImage.style.display = "none"; // Hide the popup image
}
